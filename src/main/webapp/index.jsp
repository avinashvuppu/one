...
<head>
    ...
    <title>Veerabhadra clothShop - Modern E-Commerce</title>
...
<body>
    ...
    <header>
        <div class="container header-container">
            <a href="#" class="logo">Veerabhadra cloth<span>Shop</span></a>
    ...
    <footer>
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>&copy; 2023 Veerabhadra clothShop. All rights reserved.</p>
            </div>
        </div>
    </footer>
